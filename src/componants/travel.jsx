    ...
    <section className="bg-green-100 text-gray-600 body-font">
      <div className="container px-5 py-24 mx-auto">
        <div className="flex items-center justify-between">
          <h1 className="text-6xl font-bold mb-28">Travel</h1>
          <button 
        ...
        <div className="flex flex-wrap -m-4">
          {cards.length > 0 && cards[9].companies.map(company => (
              ...
              <div className="bg-white p-4 rounded-lg">
                ...
                <div className="mb-2">
                  ...
                  <select 
                    ...
                    <option value="Eco-Friendly Accommodation"> Eco-Friendly Accommodation</option>
                    <option value="Public Transportation and Walking">Public Transportation and Walking</option>
                    <option value="Ecotourism and Responsible Tours">Ecotourism and Responsible Tours</option>
                    <option value="Pack Light and Use Eco-Friendly Gear">Pack Light and Use Eco-Friendly Gear</option>
                    <option value="Offset Your Carbon Footprint">Offset Your Carbon Footprint</option>
                    <option value="Support Sustainable Tourism Initiatives">Support Sustainable Tourism Initiatives</option>
                  </select>
                </div>
