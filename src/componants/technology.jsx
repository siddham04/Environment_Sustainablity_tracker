    ...
    <section className="bg-green-100 text-gray-600 body-font">
      <div className="container px-5 py-24 mx-auto">
        <div className="flex items-center justify-between">
          <h1 className="text-6xl font-bold mb-28">Technology</h1>
          <button 
        ...
        <div className="flex flex-wrap -m-4">
          {cards.length > 0 && cards[8].companies.map(company => (
              ...
              <div className="bg-white p-4 rounded-lg">
                ...
                <div className="mb-2">
                  ...
                  <select 
                    ...
                    <option value="Solar Chargers">Solar Chargers</option>
                    <option value="Energy-Efficient LED Light Bulbs">Energy-Efficient LED Light Bulbs</option>
                    <option value="Eco-Friendly Phone Cases">Eco-Friendly Phone Cases</option>
                    <option value="Reusable Water Bottles">Reusable Water Bottles</option>
                    <option value="Eco-Friendly Laptop Bags">Eco-Friendly Laptop Bags</option>
                    <option value="Eco-Friendly Printers">Eco-Friendly Printers</option>
                  </select>
                </div>
