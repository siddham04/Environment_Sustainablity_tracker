    ...
    <section className="bg-green-100 text-gray-600 body-font">
      <div className="container px-5 py-24 mx-auto">
        <div className="flex items-center justify-between">
          <h1 className="text-6xl font-bold mb-28">Construction</h1>
          <button 
        ...
        <div className="flex flex-wrap -m-4">
          {cards.length > 0 && cards[4].companies.map(company => (
              ...
              <div className="bg-white p-4 rounded-lg">
                ...
                <div className="mb-2">
                  ...
                  <select 
                    ...
                    <option value="Energy-Efficient Design">Energy-Efficient Design</option>
                    <option value="Renewable Energy Systems">Renewable Energy Systems</option>
                    <option value="Water-Efficient Design">Water-Efficient Design</option>
