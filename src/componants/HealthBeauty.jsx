    ...
    <section className="bg-green-100 text-gray-600 body-font">
      <div className="container px-5 py-24 mx-auto">
        <div className="flex items-center justify-between">
          <h1 className="text-6xl font-bold mb-28">Health & Beauty</h1>
          <button 
        ...
        <div className="flex flex-wrap -m-4">
          {cards.length > 0 && cards[2].companies.map(company => (
              ...
              <div className="bg-white p-4 rounded-lg">
                ...
                <div className="mb-2">
                  ...
                  <select 
                    ...
                    <option value="">Select Health and Beauty</option>
                    <option value="Organic Skincare">Organic Skincare</option>
                    <option value="Biodegradable beauty wax">Biodegradable beauty wax</option>
                    <option value="uReusable cooton pads">Reusable cooton pads</option>
                    <option value="Solid beauty products">Solid beauty products</option>
                    <option value="Natural deodrants">Natural deodrants</option>
                    <option value="Mineral Makeups">Mineral Makeups</option>
                  </select>
                </div>
