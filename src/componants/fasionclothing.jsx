    ...
    <section className="bg-green-100 text-gray-600 body-font">
      <div className="container px-5 py-24 mx-auto">
        ...
        <div className="flex flex-wrap -m-4">
          {cards.length > 0 && cards[7].companies.map(company => (
              ...
              <div className="bg-white p-4 rounded-lg">
                ...
                <div className="mb-2">
                  ...
                  <select 
                    ...
                    <option value="">Select Fasion and clothing</option>
                    <option value="Organic Cotton Clothing">Organic Cotton Clothing</option>
                    <option value="Minimalist Wardrobe">Minimalist Wardrobe</option>
                    <option value="Secondhand Clothing">Secondhand Clothing</option>
                    <option value="Artisanal Fasion">Artisanal Fasion</option>
                    <option value="Fair Trade Clothing">Fair Trade Clothing</option>
                    <option value="Sustainable Fibres">Sustainable Fibres</option>
                  </select>
                </div>
