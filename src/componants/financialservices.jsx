    ...
    <section className="bg-green-100 text-gray-600 body-font">
      <div className="container px-5 py-24 mx-auto">
        <div className="flex items-center justify-between">
          <h1 className="text-6xl font-bold mb-28">Financial Services</h1>
          <button 
        ...
        <div className="flex flex-wrap -m-4">
          {cards.length > 0 && cards[5].companies.map(company => (
              ...
              <div className="bg-white p-4 rounded-lg">
                ...
                <div className="mb-2">
                  ...
                  <select 
                    ...
                    <option value="">Select Financial Services</option>
                    <option value="Green Investment">Green Investment</option>
                    <option value="Paperless Banking">Paperless Banking</option>
                    <option value="Green Mortgages">Green Mortgages</option>
                    <option value="Carbon Offset Programmes">Carbon Offset Programmes</option>
                    <option value="Green Bonds">Green Bonds</option>
                    <option value="Community Investing">Community Investing</option>
                  </select>
                </div>
