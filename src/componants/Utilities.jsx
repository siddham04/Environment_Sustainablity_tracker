    ...
    <section className="bg-green-100 text-gray-600 body-font">
      <div className="container px-5 py-24 mx-auto">
        <div className="flex items-center justify-between">
          <h1 className="text-6xl font-bold mb-28">Utilities</h1>
          <button 
        ...
        <div className="flex flex-wrap -m-4">
          {cards.length > 0 && cards[0].companies.map(company => (
              ...
              <div className="bg-white p-4 rounded-lg">
                ...
                <div className="mb-2">
                  ...
                  <select 
                    ...
                    <option value="Solar-Powered Outdoor Lights">Solar-Powered Outdoor Lights</option>
                    <option value="LED Light Bulbs">LED Light Bulbs</option>
                    <option value="Programmable Timers">Programmable Timers</option>
                    ...
                    <option value="Faucet Aerators">Faucet Aerators</option>
                  </select>
                </div>
