    ...
    <section className="bg-green-100 text-gray-600 body-font">
      <div className="container px-5 py-24 mx-auto">
        <div className="flex items-center justify-between">
          <h1 className="text-6xl font-bold mb-28">Motor</h1>
          <button 
        ...
        <div className="flex flex-wrap -m-4">
          {cards.length > 0 && cards[6].companies.map(company => (
              ...
              <div className="bg-white p-4 rounded-lg">
                ...
                <div className="mb-2">
                  ...
                  <select 
                    ...
                    <option value="Plug-In Hybrid Electric Vehicles">Plug-In Hybrid Electric Vehicles</option>
                    <option value="Fuel-Efficient Cars">Fuel-Efficient Cars</option>
                    <option value=" Electric Bikes"> Electric Bikes</option>
                    <option value="Ride-Sharing Services">Ride-Sharing Services</option>
                  </select>
                </div>
